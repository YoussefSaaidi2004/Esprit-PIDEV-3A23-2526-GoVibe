...
public class AdminReclamationController implements Initializable {
    ...
    private HBox createReclamationCard(Reclamation r) {
        ...
        btnView.setStyle("-fx-background-color: #e3f2fd; -fx-text-fill: #1976d2; -fx-font-size: 12px; -fx-padding: 6 10; -fx-background-radius: 6; -fx-cursor: hand;");
        btnView.setOnAction(e -> showReclamationDetails(r));

        Button btnEdit = new Button("✏️");
        btnEdit.setStyle("-fx-background-color: #fff3e0; -fx-text-fill: #f57c00; -fx-font-size: 12px; -fx-padding: 6 10; -fx-background-radius: 6; -fx-cursor: hand;");
        btnEdit.setOnAction(e -> showEditDialog(r));

        Button btnDelete = new Button("🗑️");
        btnDelete.setStyle("-fx-background-color: #ffebee; -fx-text-fill: #c62828; -fx-font-size: 12px; -fx-padding: 6 10; -fx-background-radius: 6; -fx-cursor: hand;");
