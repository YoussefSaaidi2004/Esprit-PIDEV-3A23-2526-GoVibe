...
public class AdminReclamationController implements Initializable {
    ...
    private HBox createReclamationCard(Reclamation r) {
        ...
        // View button with professional icon
        Button btnView = new Button("\uD83D\uDC41 Voir");
        btnView.setStyle("-fx-background-color: #e3f2fd; -fx-text-fill: #1565c0; -fx-font-size: 12px; -fx-font-weight: 600; -fx-padding: 8 14; -fx-background-radius: 8; -fx-cursor: hand; -fx-graphic-text-gap: 6;");
        btnView.setTooltip(new Tooltip("Voir les détails"));
        btnView.setOnAction(e -> showReclamationDetails(r));

        // Reply button with professional icon
        Button btnEdit = new Button("\u2709 R\u00e9pondre");
        btnEdit.setStyle("-fx-background-color: #fff3e0; -fx-text-fill: #e65100; -fx-font-size: 12px; -fx-font-weight: 600; -fx-padding: 8 14; -fx-background-radius: 8; -fx-cursor: hand; -fx-graphic-text-gap: 6;");
        btnEdit.setTooltip(new Tooltip("R\u00e9pondre \u00e0 cette r\u00e9clamation"));
        btnEdit.setOnAction(e -> showEditDialog(r));

        // Delete button with professional icon
        Button btnDelete = new Button("\uD83D\uDDD1 Supprimer");
        btnDelete.setStyle("-fx-background-color: #ffebee; -fx-text-fill: #c62828; -fx-font-size: 12px; -fx-font-weight: 600; -fx-padding: 8 14; -fx-background-radius: 8; -fx-cursor: hand; -fx-graphic-text-gap: 6;");
        btnDelete.setTooltip(new Tooltip("Supprimer cette r\u00e9clamation"));
