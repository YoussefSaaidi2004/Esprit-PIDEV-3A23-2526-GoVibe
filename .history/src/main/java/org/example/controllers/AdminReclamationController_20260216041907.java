...
public class AdminReclamationController implements Initializable {
    ...
    private HBox createReclamationCard(Reclamation r) {
        ...
        Button btnView = createIconButton("/icons/eye.svg", "Voir", "#1565c0", "#e3f2fd");
        btnView.setOnAction(e -> showReclamationDetails(r));

        // Reply button with professional icon
        Button btnEdit = createIconButton("/icons/message.svg", "Répondre", "#e65100", "#fff3e0");
        btnEdit.setOnAction(e -> showEditDialog(r));

        // Delete button with professional icon
        Button btnDelete = createIconButton("/icons/trash.svg", "Supprimer", "#c62828", "#ffebee");
    ...
    private Button createIconButton(String iconPath, String text, String textColor, String bgColor) {
        ...
        try {
            ...
            // If icon fails to load, button will show text only
        }
