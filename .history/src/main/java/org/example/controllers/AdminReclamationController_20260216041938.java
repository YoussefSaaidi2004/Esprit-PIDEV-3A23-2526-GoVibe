...
public class AdminReclamationController implements Initializable {
    ...
    private HBox createReclamationCard(Reclamation r) {
        ...
        // View button with professional FontAwesome icon
        Button btnView = createIconButton(FontAwesomeIcon.EYE, "Voir", "#1565c0", "#e3f2fd");
        btnView.setOnAction(e -> showReclamationDetails(r));

        // Reply button with professional FontAwesome icon
        Button btnEdit = createIconButton(FontAwesomeIcon.ENVELOPE, "Répondre", "#e65100", "#fff3e0");
        btnEdit.setOnAction(e -> showEditDialog(r));

        // Delete button with professional FontAwesome icon
        Button btnDelete = createIconButton(FontAwesomeIcon.TRASH, "Supprimer", "#c62828", "#ffebee");
    ...
    private Button createIconButton(FontAwesomeIcon icon, String text, String textColor, String bgColor) {
        ...
        iconView.setSize("16");
        iconView.setFill(javafx.scene.paint.Color.web(textColor));
