...
public class ReclamationController {
    ...
    private void handleEnvoyer() {
        ...
        // Use default user ID 1 for demo - in production, get from SessionManager
        int userId = 1;
    ...
    private void handleRetour() {
        SceneNavigator.switchTo("/org/example/UserHomeView.fxml", (Node) comboSujet);
    }
    ...
    private void handleLocations() {
        SceneNavigator.switchTo("/VoitureListView.fxml", (Node) comboSujet);
    }

    @FXML
    private void handleFlights() {
        SceneNavigator.switchTo("/views/flight-management.fxml", (Node) comboSujet);
    }

    @FXML
    private void handleChambres() {
        SceneNavigator.switchTo("/main-layout.fxml", (Node) comboSujet);
    }

    @FXML
    private void handleForums() {
        SceneNavigator.switchTo("/poste-forumviews/ListForum.fxml", (Node) comboSujet);
    }
