...
public class UserHeaderController {
    ...
    private void handleActivities() {
        ...
        SceneNavigator.switchTo("/UserHome.fxml", getContextNode());
    }

    @FXML
    private void handleLocations() {
        System.out.println("[Nav] Locations clicked");
        // Navigate to the Car Browsing View instead of the Rental List
        org.example.mains.MainApp.switchScene("/UserVoituresView.fxml", "Louer une Voiture");
    }
    ...
    private void handleChambres() {
        ...
        org.example.mains.MainApp.switchScene("/chambre-view.fxml", "Chambres Disponibles");
    }
    ...
    private void handleProfile() {
        ...
        // Implementing basic alert for now or navigation if Profile view exists
        // SceneNavigator.switchTo("/ProfileView.fxml", getContextNode()); 
        // For now:
    ...
    private void handleMyReservations() {
        ...
        SceneNavigator.switchTo("/chambre-view.fxml", getContextNode());
    }
