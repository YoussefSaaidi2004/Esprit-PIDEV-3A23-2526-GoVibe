...
public class ServiceActivite {
    ...
    // ✅ LISTE POUR CLIENTS (sans filtre status si colonne inexistante)
    public List<Activite> getAll() throws SQLException {
        List<Activite> list = new ArrayList<>();
        // ⚠️ Requête sans filtre status pour compatibilité
        String sql = "SELECT * FROM activite ORDER BY id";
    ...
    // ✅ LISTE VALIDATION (PENDING UNIQUEMENT) - Retourne liste vide si colonne inexistante
    public List<Activite> getAllPending() throws SQLException {
        ...
        try {
            ...
            // Colonne status inexistante - retourne liste vide
            System.out.println("[ServiceActivite] Colonne status inexistante, retourne liste vide");
        }
        return list;
    }
