...
public class ForgotPasswordController {
    ...
    private void handleSendResetLink() {
        ...
        try {
            if (servicePersonne.emailExists(email)) {
                ...
                // Send Email
                String subject = "GoVibe - Réinitialisation de mot de passe";
                String body = "Bonjour,\n\nVotre code de réinitialisation est : " + token + "\n\nCe code expire dans 15 minutes.";
                emailService.sendEmail(email, subject, body);
                
                showMessage("Code envoyé ! Vérifiez votre email.", false);
                
                // Navigate to Reset Password Screen with email pre-filled potentially?
                // Or just navigate and ask for code + new password.
            ...
            e.printStackTrace();
            showMessage("Erreur système.", true);
        }
    }
    ...
    private void loadResetPasswordView(String email) {
        try {
            ...
            // Pass email to next controller if possible
            ...
            e.printStackTrace();
            showMessage("Erreur de navigation vers la réinitialisation.", true);
        }
    }
