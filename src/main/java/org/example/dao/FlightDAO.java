...
public class FlightDAO {
    ...
    public boolean create(Flight flight) {
        ...
        Connection conn = UnifiedDatabaseManager.getConnection();
        if (conn == null) {
            System.err.println("DB connection is null. Cannot create flight.");
            return false;
        }
    ...
    public List<Flight> findAll() {
        ...
        Connection conn = UnifiedDatabaseManager.getConnection();
        if (conn == null) {
            System.err.println("DB connection is null. Returning empty flights list.");
            return flights;
        }
    ...
    public Flight findById(String flightId) {
        ...
        Connection conn = UnifiedDatabaseManager.getConnection();
        if (conn == null) {
            System.err.println("DB connection is null. Cannot find flight by id.");
            return null;
        }
    ...
    public boolean update(Flight flight) {
        ...
        Connection conn = UnifiedDatabaseManager.getConnection();
        if (conn == null) {
            System.err.println("DB connection is null. Cannot update flight.");
            return false;
        }
    ...
    public boolean delete(String flightId) {
        ...
        Connection conn = UnifiedDatabaseManager.getConnection();
        if (conn == null) {
            System.err.println("DB connection is null. Cannot delete flight.");
            return false;
        }
